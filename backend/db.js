...
const SEED_EVENTS = [
  ...
  { title: 'Nutrition Talk: Eating Well After 60', description: 'Registered dietitian shares evidence-based advice on balanced diets, managing diabetes through food, and meal planning on a budget.', date: '2026-04-28', time: '10:00', end_time: '11:30', location: 'Woodlands Health Campus Community Hub, 17 Woodlands Dr 17', region: 'Woodlands', source: 'AIC', source_url: 'https://www.aic.sg', category: 'Talk', organizer: 'Agency for Integrated Care' },
  { title: 'Seniors Movie Screening: "Ilo Ilo"', description: 'Community screening of the acclaimed Singapore film "Ilo Ilo" (2013). Subtitles in English, Chinese, and Malay. Refreshments included.', date: '2026-04-30', time: '14:30', end_time: '17:00', location: 'Tampines Hub The Star Performing Arts Centre (Function Room)', region: 'Tampines', source: 'Tampines CC', source_url: 'https://www.pa.gov.sg', category: 'Social', organizer: 'Tampines Community Club' },
];
      ...
      for (const e of SEED_EVENTS) {
        await query(
          ...
          [e.title, e.description, e.date, e.time, e.end_time,
           e.location, e.region, e.source, e.source_url, e.category, e.organizer]
        );
      }
